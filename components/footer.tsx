...
export default function Footer() {
  return (
    <>
      <div className="hidden sm:flex flex-col gap-8 mb-2 mt-16 mx-16 selection:bg-amber-900/50">
...
function ServiceSession() {
  return (
    <div className="flex flex-col space-y-2 text-amber-900">
      <a href="/services" className="flex items-center space-x-2 text-xl text-amber-900 font-medium mb-2 -translate-x-2">
