...
function Subheading() {
  return (
    <div
      className="flex justify-center -translate-x-2 sm:-translate-x-0 items-start gap-2 sm:gap-4 sm:flex-row sm:flex-wrap flex-col text-amber-900 selection:bg-amber-900/30">
      <a
        href="/construction"
